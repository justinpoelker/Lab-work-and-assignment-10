...
import static com.mycompany.dllists_stacks_queues.DoublyLinkedList.reverseString;
...
public class DoublyLinkedListDemoApp {
   public static void main(String[] args) {
     ...
     System.out.print("The sum of last "+ numList.sumOfLast(3)  );

     

        String str = "hello";
        String example = reverseString(str);
